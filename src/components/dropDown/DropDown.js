...
import { NO_FILTER, handleDropDownFilter } from '../../controllers/filterController';
...
export default function DropDown({options}) {
    ...
    let { setCountries, searchedCountries} = useCountries();
    ...
    function handleOptionSelect(option) {
        ...
        handleDropDownFilter(option, searchedCountries, favourites, setCountries);
    };
